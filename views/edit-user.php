                ...
                <div class="row justify-content-center">
                    ...
                    <?php
                            if($user['photo']){
                                ...
                                ?>
                        <input type="file" name="photo" id="photo" class="form-control mt-2" accept="image/*"><!--accept:limit the extension that this form accept. in this case photo/jpg. png. gif. jpeg(maybe also usable for documents or other type of extencion)you can even specify the extencions that you can accept-->
                    </div>
                </div>
